...
@section('title','Responsive Portfolio Website')
...
<main class="main">
            ...
            <section class="home section" id="home">
                <div class="home_container container grid">
                    <div class="home_img">
                        <img src="{{asset('front/assets/img/home.png')}}" alt="">
                    </div>
            ...
            <section class="about section" id="about">
               ...
               <div class="about_container container grid">
                 <img src="{{asset('front/assets/img/about-img.png')}}" alt="" class="about_img">
                 ...
                 <div class="about_data">
                    ...
                    <div class="about_buttons">
                        <a href="{{asset('front/assets/pdf/johndoe-Cv.pdf')}}" class="button button--flex">
              ...
              <div class="portfolio_container container swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="portfolio_content grid swiper-slide">
                        <img src="{{asset('front/assets/img/portfolio1.jpeg')}}" alt="" class="portfolio_img">
                    ...
                    <!--============ PORTFOLIO 2 ==============-->
                    <div class="portfolio_content grid swiper-slide">
                        <img src="{{asset('front/assets/img/portfolio2.jpeg')}}" alt="" class="portfolio_img">
                    ...
                    <!--============ PORTFOLIO 3 ==============-->
                    <div class="portfolio_content grid swiper-slide">
                        <img src="{{asset('front/assets/img/portfolio3.jpeg')}}" alt="" class="portfolio_img">
            ...
            <section class="project section">
              <div class="project_bg">
                <div class="project_container container grid">
                    ...
                    <img src="{{asset('front/assets/img/home.png')}}" alt="" class="project_img">
                </div>
              </div>
            </section>
              ...
              <div class="testimonial_container container swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="{{asset('front/assets/img/testimonial1.jpeg')}}" alt="" class="testimonial_img">
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="{{asset('front/assets/img/testimonial2.jpg')}}" alt="" class="testimonial_img">
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="{{asset('front/assets/img/testimonial3.jpeg')}}" alt="" class="testimonial_img">
